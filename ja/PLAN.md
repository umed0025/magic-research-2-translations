...
| 3 | 未定（下記「次のバッチ候補」参照） | - | 未着手 |

**進捗: 1610 / 4646 件（約34.7%）**
...
2. **中程度の説明文・ステータス表記**（21〜100文字、約1884件）: UIツールチップやアイテム・呪文の効果説明が中心。
3. **Storyline名一覧**（`(Storyline) ...`で始まるキー、数百件規模）: 実績名。用語集と整合させながら進める。
